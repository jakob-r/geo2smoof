#' @title Converts a Elevation To Single Objective Function
...
if (FALSE) {
  ...
  ranges = data.frame(x = lon.range, y = lat.range)
  elev = elevatr::get_elev_raster(locations = ranges, prj = "+proj=longlat +ellps=WGS84 +datum=WGS84 +no_defs", src = "aws")
}
